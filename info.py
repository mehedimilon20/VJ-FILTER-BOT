...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002316055045').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mehedimilon2')
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'rslinks.net')
SHORTLINK_API = environ.get('SHORTLINK_API', '?hA?Q94h44')
